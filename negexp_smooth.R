# rasters smoothing with negative exponential function 
library(raster)
...
smoothed <- tl2
smoothed[] <- sapply(seq(ncell(tl2)), function(x) cell_nex_smooth(tl2, x, 0.0001))
